<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="font-bold text-2xl text-gray-800">Edit Task</h2>
            <p class="text-sm text-gray-600 mt-1">Update your task details</p>
        </div>
    </x-slot>
                ...
                <div class="p-8">
                    <form action="{{ route('tasks.update', $task) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="status"
                                    id="status"
                                    class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200 @error('status') border-red-500 @enderror">
